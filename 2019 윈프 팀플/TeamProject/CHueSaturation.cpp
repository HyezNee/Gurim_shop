...
// CHueSaturation 대화 상자

IMPLEMENT_DYNAMIC(CHueSaturation, CDialogEx)

//CHueSaturation::CHueSaturation(CWnd* pParent /*=nullptr*/)
//	: CDialogEx(IDD_DIALOG_CUTPREV, pParent)
//{
//
//}

CHueSaturation::CHueSaturation(CAdvImg* img, CRgn* rgn, CWnd* pParent)
	:CDialogEx(IDD_DIALOG_SATURATION, pParent)
{
...
void CHueSaturation::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CHueSaturation, CDialogEx)
	//ON_NOTIFY(NM_CUSTOMDRAW, IDC_SLIDER_ALPHA, &CHueSaturation::OnNMCustomdrawSliderAlpha)
	//ON_BN_CLICKED(IDC_CHECK_BLUR, &CHueSaturation::OnBnClickedCheckBlur)
	ON_BN_CLICKED(IDC_APPLYBT, &CHueSaturation::OnBnClickedApplybt)
	ON_NOTIFY(NM_CUSTOMDRAW, IDC_SLIDER_HUE, &CHueSaturation::OnNMCustomdrawSliderHue)
	//ON_NOTIFY(NM_CUSTOMDRAW, IDC_SLIDER_BETA, &CHueSaturation::OnNMCustomdrawSliderBeta)
END_MESSAGE_MAP()


// CHueSaturation 메시지 처리기



BOOL CHueSaturation::PreCreateWindow(CREATESTRUCT& cs)
{
...
BOOL CHueSaturation::OnInitDialog()
{
...
/*void CHueSaturation::OnNMCustomdrawSliderAlpha(NMHDR* pNMHDR, LRESULT* pResult)
{
...
void CHueSaturation::setPreviewImg()
{
...
/*void CHueSaturation::OnBnClickedCheckBlur()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
}*/


void CHueSaturation::OnBnClickedApplybt()
{
	setPreviewImg();
}


void CHueSaturation::OnNMCustomdrawSliderHue(NMHDR* pNMHDR, LRESULT* pResult)
{
	LPNMCUSTOMDRAW pNMCD = reinterpret_cast<LPNMCUSTOMDRAW>(pNMHDR);
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	*pResult = 0;
...
/*void CHueSaturation::OnNMCustomdrawSliderBeta(NMHDR* pNMHDR, LRESULT* pResult)
{
	LPNMCUSTOMDRAW pNMCD = reinterpret_cast<LPNMCUSTOMDRAW>(pNMHDR);
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	*pResult = 0;
