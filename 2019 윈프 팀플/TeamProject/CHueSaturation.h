...
class CHueSaturation : public CDialogEx
{
	DECLARE_DYNAMIC(CHueSaturation)

public:
	//CHueSaturation(CWnd* pParent = nullptr);   // 표준 생성자입니다.
	CHueSaturation(CAdvImg* img, CRgn* rgn, CWnd* pParent = nullptr);
	virtual ~CHueSaturation();
