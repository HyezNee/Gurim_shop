...
class CMosaic : public CDialogEx
{
	DECLARE_DYNAMIC(CMosaic)

public:
	//CMosaic(CWnd* pParent = nullptr);   // 표준 생성자입니다.
	CMosaic(CAdvImg* img, CRgn* rgn, CWnd* pParent = nullptr);
	virtual ~CMosaic();
